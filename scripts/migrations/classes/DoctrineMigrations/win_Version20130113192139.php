...
class Version20130113192139 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $unix_path = "$realpath/../../../data/";
        $windows_path = "c:\\wamp\\www\\dcr-proj\\scripts\\migrations\\data";
        
        $file_path = $windows_path;
                
        // load areas list
        $this->addSql("LOAD DATA INFILE '$file_path\\area.csv'
                        INTO TABLE areas
                            FIELDS TERMINATED BY ','
                                OPTIONALLY ENCLOSED BY '\"'");
        // load cities list
        $this->addSql("LOAD DATA INFILE '$file_path\\city.csv'
                        INTO TABLE cities
                            FIELDS TERMINATED BY ','
                                OPTIONALLY ENCLOSED BY '\"'");
        ...
        // load sample entries
        $this->addSql("LOAD DATA INFILE '$file_path\\entries.csv'
                        INTO TABLE entries
                            FIELDS TERMINATED BY ','
                                OPTIONALLY ENCLOSED BY '\"'");
